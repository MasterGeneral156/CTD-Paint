...
public class Config {
    ...
    private static void initGeneralConfig(Configuration cfg) 
    {
        ...
        disableJEI = cfg.getBoolean("disableJEI", CATEGORY_GENERAL, disableJEI, "Set to true to disable integration with Just Enough Items.");
        disableMoGlowstone = cfg.getBoolean("disableMoGlowstone", CATEGORY_GENERAL, disableMoGlowstone, "Set to true to disable integration with Mo' Glowstone");
