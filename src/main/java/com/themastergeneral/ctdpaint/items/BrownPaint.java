...
public class BrownPaint extends PaintBrush {
	private Block containedBlock;

	public BrownPaint(String unlocalizedName, String modid) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn,
		...
		if (!worldIn.isRemote) {
			...
			if (PaintBrown.instance().getRecipeResult(iblockstate) != Blocks.AIR
					.getDefaultState()) {
				stack.damageItem(1, playerIn);
				worldIn.setBlockState(pos,
						PaintBrown.instance().getRecipeResult(iblockstate));
