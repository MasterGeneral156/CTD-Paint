...
public class OrangePaint extends PaintBrush {
	private Block containedBlock;

	public OrangePaint(String unlocalizedName, String modid) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn,
		...
		if (!worldIn.isRemote) {
			...
			if (PaintOrange.instance().getRecipeResult(iblockstate) != Blocks.AIR
					.getDefaultState()) {
				stack.damageItem(1, playerIn);
				worldIn.setBlockState(pos,
						PaintOrange.instance().getRecipeResult(iblockstate));
