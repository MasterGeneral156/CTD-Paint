...
public class PurplePaint extends PaintBrush {
	private Block containedBlock;

	public PurplePaint(String unlocalizedName, String modid) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn,
		...
		if (!worldIn.isRemote) {
			...
			if (PaintPurple.instance().getRecipeResult(iblockstate) != Blocks.AIR
					.getDefaultState()) {
				stack.damageItem(1, playerIn);
				worldIn.setBlockState(pos, PaintPurple.instance()
