...
public class YellowPaint extends PaintBrush {
	...
	public YellowPaint(String unlocalizedName, String modid) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn,
		...
		if (!worldIn.isRemote) {
			...
			if (PaintYellow.instance().getRecipeResult(iblockstate) != Blocks.AIR
					.getDefaultState()) {
				stack.damageItem(1, playerIn);
				worldIn.setBlockState(pos, PaintYellow.instance()
